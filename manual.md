...
Чтобы текст был зачеркнутый, необходимо обромить двойным тильда (~~). Например вот так:
...
* регистрирует ваше имя в системе*.
...
## Работа с удаленными Git-репозиториями (github.com)
...
Чтобы вывести краткое содержание всех коммитов, необходимо набрать команду:

git log --oneline

Чтобы отображать изменения (что добавили, что удалили), необходимо набрать:
